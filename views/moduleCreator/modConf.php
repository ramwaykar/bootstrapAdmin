    ...
    function getModConf() {
        ...
        return array(
            ...
            'listDisplayFields' => array(
                'name', 'status', 'createdBy', 'updatedBy', 'createdAt', 'updatedAt'
            ),
            'listSelectFields' => array(
                'id as DT_RowId', 'name', 'status', 'createdBy as CB', 'updatedBy as UB', 'createdAt', 'updatedAt'
            ),
            'searchFields' => array(
